            ...
            <div class="container">
                  <div class="row margin-xlarge-top">
                        <div class="col s12 m12 l12">
                              <form method="POST" action="include/addpatient.php">
                                    <div class="card card-center z-depth-2">
                                          <div class="card-header center-align">
                                                  <h5 class="white-text">Add Patient</h5>
                                          </div>
                                          <div class="card-content">
                                                ...
                                                <div class="input-field col s12">
                                                      <textarea id="home_address" name="home_address" class="materialize-textarea" required></textarea>
                                                      <label for="home_address">Home Address</label>
                                                </div>
                                                <div class="input-field col s12">
                                                      <input type="date" class="datepicker2" name="dateofbirth" placeholder="Date of Birth" required>
                                                </div>
                                                <button class="waves-effect waves-light btn blue btn btn-max-width">Add Patient</button>
