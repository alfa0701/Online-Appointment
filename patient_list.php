...
<body>
      <header>
            <ul id="slide-out" class="side-nav fixed z-depth-2">
                  ...
                  <li class="active"><a class="waves-effect" href="patient_list.php"><span class="fa fa-vcard black-text fa-lg"></span> Patient List</a></li>
                  <li>
                        <div class="divider"></div>
                  </li>
      ...
      <main class="main-content">
            <div class="row">
                  <form method="POST" action="include/search_func.php">
                        ...
                        <table class="bordered highlight">
                              ...
                              <tbody>
                                    <?php
                                          ...
                                          if(isset($_GET["name"])){
                                                $sql="SELECT patient_ID, firstname, lastname, middlename, home_address, DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), dateofbirth)), '%Y')+0 AS age, dateofbirth FROM patient_info WHERE firstname =" . $_GET['name']."OR lastname=".$_GET['name']."OR middlename=".$_GET['name'];
                                          }else{
                                                $sql="SELECT  patient_ID, firstname, lastname, middlename, home_address, DATE_FORMAT(FROM_DAYS(DATEDIFF(NOW(), dateofbirth)), '%Y')+0 AS age, dateofbirth FROM patient_info";
                                          }
                                          ...
                                          if($result -> num_rows > 0){
                                                while($rows = $result -> fetch_assoc()){
                                                      ...
                                                      echo"<tr>";
                                                            ...
                                                            echo"<td><a href='view_patient.php?patientID=$patientID'>View</a></td>";
                                                      echo"</tr>";
                                                }
                                          }else{
